...
# ================= LOAD MODEL =================
model = joblib.load("ulcer_model.pkl")
...
"""
    ...
    def save_pdf(self):
        ...
        filename = f"{self.patient_id}_Report.pdf"
    ...
    def export_history(self):
        ...
        df.to_csv("patient_history.csv",
                  mode='a',
                  header=not pd.io.common.file_exists("patient_history.csv"),
                  index=False)
